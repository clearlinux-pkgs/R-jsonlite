...
Version  : 2.0.0
Release  : 123
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/jsonlite_2.0.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/jsonlite_2.0.0.tar.gz
...
%setup -q -n jsonlite
pushd ..
cp -a jsonlite buildavx2
popd
pushd ..
cp -a jsonlite buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743084087
...
/usr/lib64/R/library/jsonlite/tests/testthat/test-toJSON-indent.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/jsonlite/libs/jsonlite.so
/V4/usr/lib64/R/library/jsonlite/libs/jsonlite.so
