...
Version  : 1.7.1
Release  : 87
URL      : https://cran.r-project.org/src/contrib/jsonlite_1.7.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/jsonlite_1.7.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599607303
...
/usr/lib64/R/library/jsonlite/tests/testthat/test_rbind_pages-names.R
