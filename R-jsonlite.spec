...
Version  : 1.3
Release  : 42
URL      : http://cran.r-project.org/src/contrib/jsonlite_1.3.tar.gz
Source0  : http://cran.r-project.org/src/contrib/jsonlite_1.3.tar.gz
...
%build
export LANG=C
export SOURCE_DATE_EPOCH=1488380743
